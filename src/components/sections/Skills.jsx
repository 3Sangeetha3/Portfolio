  ...
  const skillsData = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "AWS", icon: "https://cdn.jsdelivr.net/npm/devicon/icons/amazonwebservices/amazonwebservices-original-wordmark.svg" },
        { name: "Docker", icon: "https://cdn.jsdelivr.net/npm/devicon/icons/docker/docker-original.svg" },
        { name: "Terraform", icon: "https://cdn.jsdelivr.net/npm/devicon/icons/terraform/terraform-original.svg" },
